...
<body>
    <div class="form-container">
        ...
        <form id="registerForm" method="POST" action="<?php echo e(route('user.register')); ?>">
            <?php echo csrf_field(); ?>
    ...
    document.getElementById('registerForm').addEventListener('submit', function(e) {
        ...
        fetch('<?php echo e(route("user.register")); ?>', {
            method: 'POST',
            body: formData,
            headers: {
...
</html><?php /**PATH C:\Users\selma\Formulario_CadastroUsuario_Laravel\resources\views/user/register.blade.php ENDPATH**/ ?>